...
public:
  ...
  void imageProcessing()
  {
    ...
    //new manually visualize the x and y values of 2d image of zip-tie
      // pixel_x.clear();
      // pixel_y.clear();
      ...
      for (int i = 0; i < pixel_size; i++){
        ...
        if (depth > 0.2){
          ...
          ofstream myfile;
          myfile.open ("/home/pengchang/Desktop/ziptie2.txt", std::ofstream::out | std::ofstream::app); //append mode

...
int main(int argc, char ** argv)
{
	...
	double record1 = 1.5; // need more data
	double record2 = 0.864744;
	double record3 = 0.461111;
	double record4 = 0.159313;
	...
	//load external force
	geometry::RaveVector<double> force = {0.0,-0.98,0.0}; // ForceTorqueMap asks for geometry::RaveVector
